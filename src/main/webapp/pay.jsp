    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="pay.jsp">Pay Bills</a>
                </li>
            </ul>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="details-box mx-auto my-4 p-4 bg-light rounded">
                <h1 class="text-center">Pay Utility Bills</h1>
                <form id="payBillForm">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="biller" name="biller" placeholder="Biller Name" required />
                    </div>
                    <div class="form-group mb-3">
